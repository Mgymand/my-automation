...
#     photo: ホール画像（16:9）上で光るピンの位置、place: その場所にキャラを合成する指示（場面画像の生成に使う）、npc: 持ち場の仲間チップの位置 ---
SCENES = [
    {"id": "hall",     "view": "dashboard", "label": "ギルドホール",  "icon": "🏰", "x": 50, "y": 50,
     "photo": {"x": 50, "y": 50},
     "place": "sitting relaxed on a chair at the large map table in the left foreground, one hand resting on the map, looking toward the viewer with a welcoming smile",
    ...
    {"id": "map",      "view": "map",       "label": "ワールドマップ", "icon": "🗺️", "x": 18, "y": 70,
     "photo": {"x": 26, "y": 57},
     "place": "standing at the large map table in the left foreground, leaning over the map and pointing at a spot on it", "npc": {"x": 35, "y": 72},
    ...
    {"id": "board",    "view": "board",     "label": "クエスト掲示板", "icon": "📜", "x": 38, "y": 44,
     "photo": {"x": 90, "y": 36},
     "place": "standing in front of the quest notice board on the right wall, looking up at the pinned notices", "npc": {"x": 79, "y": 58},
    ...
    {"id": "list",     "view": "list",      "label": "物件図鑑",       "icon": "📖", "x": 10, "y": 52,
     "photo": {"x": 27, "y": 39},
     "place": "standing at the tall bookshelf on the left, pulling out a book",
    ...
    {"id": "schedule", "view": "schedule",  "label": "冒険の暦",       "icon": "🕰️", "x": 64, "y": 18,
     "photo": {"x": 71, "y": 13},
     "place": "standing near the lantern below the balcony in the center-right, looking up at it",
    ...
    {"id": "import",   "view": "import",    "label": "素材の搬入",     "icon": "📦", "x": 68, "y": 68,
     "photo": {"x": 80, "y": 61},
     "place": "standing beside the wooden crates on the right, checking a rolled scroll",
    ...
    {"id": "pois",     "view": "pois",      "label": "街の施設",       "icon": "🏥", "x": 38, "y": 70,
     "photo": {"x": 67, "y": 42},
     "place": "standing in the open doorway in the center, looking out at the town", "npc": {"x": 72, "y": 51},
    ...
    {"id": "stats",    "view": "stats",     "label": "領地の統計",     "icon": "📈", "x": 46, "y": 18,
     "photo": {"x": 5, "y": 55},
     "place": "standing beside the globe in the left foreground, one hand on the globe",
    ...
    {"id": "journal",  "view": "journal",   "label": "ギルド日誌",     "icon": "📯", "x": 56, "y": 70,
     "photo": {"x": 12, "y": 42},
     "place": "sitting in the armchair by the fireplace on the left, reading a ledger", "npc": {"x": 20, "y": 63},
    ...
    {"id": "settings", "view": "settings",  "label": "ギルド設定",     "icon": "⚙️", "x": 64, "y": 44,
     "photo": {"x": 48, "y": 40},
     "place": "standing at the foot of the staircase in the center, one hand on the railing",
