...
#   elderly-sharehouse-hearing-sheet-sample.html    → 1枚版の記入例（春日部市東中野の物件）
#   elderly-sharehouse-hearing-sheet-2p-sample.html → 2枚版の記入例（同上）
...
for name in elderly-sharehouse-hearing-sheet elderly-sharehouse-hearing-sheet-2p elderly-sharehouse-hearing-sheet-sample elderly-sharehouse-hearing-sheet-2p-sample; do
  src="$DIR/$name.html"
  [ -f "$src" ] || continue
  out="$DIR/$name.pdf"
